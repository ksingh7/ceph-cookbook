...
##################################### Configuration for ceph-node1 #####################################################
				...
				v.gui = true
                                ...
                                v.customize ['createhd', '--filename', ceph_node1_disk2, '--size', 1 * 10240]
                                ...
                                v.customize ['createhd', '--filename', ceph_node1_disk3,'--size', 1 * 10240]
                                ...
                                v.customize ['createhd', '--filename', ceph_node1_disk4,'--size', 1 * 10240]
...
##################################### Configuration for ceph-node2 #####################################################
 		...
 		config.vm.define :"ceph-node2" do |node2|
				...
				v.gui = true
                                ...
                                v.customize ['createhd', '--filename', ceph_node2_disk2,'--size', 1 * 10240]
                                ...
                                v.customize ['createhd', '--filename', ceph_node2_disk3,'--size', 1 * 10240]
                                ...
                                v.customize ['createhd', '--filename', ceph_node2_disk4,'--size', 1 * 10240]
...
##################################### Configuration for ceph-node3 #####################################################
                ...
                config.vm.define :"ceph-node3" do |node3|
                        ...
                        node3.vm.provider "virtualbox" do |v|
                                ...
                                v.customize ['createhd', '--filename', ceph_node3_disk2,'--size', 1 * 10240]
                                ...
                                v.customize ['createhd', '--filename', ceph_node3_disk3,'--size', 1 * 10240]
                                ...
                                v.customize ['createhd', '--filename', ceph_node3_disk4,'--size', 1 * 10240]
